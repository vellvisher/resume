...
\usepackage[scale=0.8, margin=0.95in]{geometry}
\usepackage{hyperref}
\usepackage{verbatim}
...
\firstname{Vaarnan}
\familyname{Drolia}
\address{250 Kendall Street, \#307, Cambridge, Massachusetts}{02142}
\mobile{+1-415-4849415}
%\phone{(415) 4849-415}
\email{vaarnan@gmail.com}
%\homepage{http://shiftv.blogspot.com/}
\extrainfo{\href{http://github.com/vellvisher}{GitHub}}
\extrainfotwo{\href{http://linkedin.com/in/vaarnan}{LinkedIn}}
...
\cventry{May, 2014}{Bachelor of Computing in Computer Science}{National University of Singapore}{}{\textit{4.51/5.00}}
{\begin{itemize}
...
\cventry{May 2013 - August 2013}{Software Engineering Intern}{Google Inc.}{}{Play Magazines}
{\begin{itemize}
...
which selected meritorious studets to promote research amoung young students
\end{itemize}
\end{comment}
\end{document}
